...
import sys
sys.path.append("..")
from IUdata.vocab_creation import Vocabulary, JsonReader
import numpy as np
...
if __name__ == '__main__':
    vocab_path = '/home/gaurab/Report_Generation_27Feb/my_project/IUdata/data_vocab.pkl'
    image_dir = '/home/gaurab/Report_Generation_27Feb/my_project/IUdata/FrontalView_IUXRay'
    data_json = '/home/gaurab/Report_Generation_27Feb/my_project/IUdata/data_trainval.json'
    batch_size = 8
    resize = 256
    crop_size = 224
    num_workers = 2
